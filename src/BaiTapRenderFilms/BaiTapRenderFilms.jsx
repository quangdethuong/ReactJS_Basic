...
import dataFilms from '../DataFilm/DataFilms.json'

export default class BaiTapRenderFilms extends Component {
    renderFilms = () => {
        return dataFilms.map((films, index) => {
            return (
                <div className="col-3" key={index}>
                    <div className="card text-white bg-primary">
                        <img className="card-img-top" src={films.hinhAnh} alt="phim" />
    ...
    render() {
        return (
            ...
            <div style={{ backgroundImage: 'url(./background/avanger.jpg)', width: '100%', minHeight: '2000px', backgroundRepeat: 'no-repeat', backgroundSize: 'contain' }}>
